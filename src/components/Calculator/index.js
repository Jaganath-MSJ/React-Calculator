...
export default function Calculator() {
  ...
  return (
    <Container>
      ...
      <Button onClick={headleDelete} control>
        DEL
      </Button>
      <Button data={"÷"} onClick={chooseOpeation} operation>
        ÷
      </Button>
      ...
      <Button data={"x"} onClick={chooseOpeation} operation>
        x
      </Button>
      ...
      <Button onClick={equals} gridSpan={2} equals>
        =
      </Button>
    </Container>
  );
